...
with open('/Users/fefox/Library/Mobile Documents/com~apple~CloudDocs/Università Magistrale/KEBDI/PROGETTO - Supply Chain/Prolog/fatti.pl', 'r') as f:
    text = f.read()
    #print(text)
...
with open('/Users/fefox/Library/Mobile Documents/com~apple~CloudDocs/Università Magistrale/KEBDI/PROGETTO - Supply Chain/Prolog/fatti.pl', 'w') as f:
    f.write(text)
    print("DONE.")